...
//
	...
	ListView listView;
//	List<Groop> groceries = new ArrayList<>();

//	DaoSession daoSession;
//	ArrayAdapter<Groop> groceryArrayAdapter;
...
//		final Groop selectedGroceryItem = groceries.get(position);
//
...
//	private void proceedToUpdateItem(Groop grocery){
